...
function Connect() {
  const [state, handleSubmit] = useForm('xjgldzya');

  return (
    <div id="contact">
      <section className="min-h-[50vh] py-16 px-6 flex flex-col items-center bg-[#0a0a0a] text-white font-sans pt-22">
        ...
        <div className="grid md:grid-cols-2 gap-16 max-w-5xl w-full">
          ...
          <div className="flex flex-col space-y-6">
            ...
            <div className="flex gap-6 pt-4">
              <a href="https://linkedin.com/in/dev-dhakal" target="_blank" rel="noreferrer" className="transition-transform hover:-translate-y-1">
              ...
              <a href="https://github.com/Dev763" target="_blank" rel="noreferrer" className="transition-transform hover:-translate-y-1">
                <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path></svg>
              </a>
              <a href="mailto:dhakaldev92@gmail.com" className="transition-transform hover:-translate-y-1">
          ...
          {state.succeeded ? (
            <div className="flex items-center justify-center">
              <p className="text-green-400 text-xl font-semibold">Message sent! I'll get back to you soon. ✓</p>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="flex flex-col space-y-5">
              <div className="grid grid-cols-2 gap-4">
                ...
                <input
                  ...
                  className="p-4 bg-zinc-900 border border-zinc-800 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none"
                />
                <ValidationError field="email" errors={state.errors} className="text-red-400 text-sm col-span-2" />
              </div>
              <textarea
              ...
              ></textarea>
              <ValidationError field="message" errors={state.errors} className="text-red-400 text-sm" />
              <button
                type="submit"
                disabled={state.submitting}
                className="bg-white text-black font-bold py-4 rounded-lg hover:bg-blue-500 hover:text-white transition-all duration-300 disabled:opacity-50"
              >
