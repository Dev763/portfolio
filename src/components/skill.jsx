...
const Skill = () => {
  ...
  useEffect(() => {
    const handleResize = () => {
      setRadius(window.innerWidth < 768 ? 100 : 150);
    };
  ...
  return (
    <div
      id="skill"
      className="relative min-h-screen py-20 px-4 md:px-16 overflow-hidden flex flex-col justify-center bg-[#08080c]"
    >
      {/* BACKGROUND */}
      ...
      <h1 className="text-3xl flex justify-center mb-8 mt-12 text-white font-bold">
        Skills & Certificates
      </h1>
            ...
            return (
              ...
              >
                <motion.div
                  ...
                  className="p-4 rounded-full bg-white/5 border border-white/10 backdrop-blur-md text-3xl flex items-center justify-center"
                >
                  {skill.icon}
                </motion.div>
              </motion.div>
